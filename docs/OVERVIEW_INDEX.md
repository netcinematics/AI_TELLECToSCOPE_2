...
This introduces the concept of AXIOM_COLLECTOR!

_______________________________________________________

### KEY_PRACTICE: "AXIOM_COLLECTOR"

Another key practice of ALPHABITZA is the fabulous fictional story of the AXIOM_COLLECTOR!

As an enjoyable thought experiment, that poses many interesting questions.

> If we had PRISTINE_LEXICON, perhaps GRAMMAR from the future (1000 years) - what would it say?

If we were enabled to by EXTRA_EXACTNESS or LESS_AMBIGUITY - what would it say?

If our words could be abbreviated (with "ABBREVIATION") - what would it say?

So, this is the idea for the AXIOM_COLLECTOR concept in AI.

> AXIOM_COLLECTOR is also the KEY to COST REDUCTIONS for COMMON BUSINESS COMPUTE!

_________________________________________________________

#### "AXIOM_COLLECTOR" - is the search by AI or Human, to gather "shortest way to say concepts exactly".

As an additional NOVEL PROCESS, called "EXACTIFICATION"!

#### "EXACTIFICATION" is a sibling principle to COMBINIFICATION and BREVITY, as "MECHZ" or TOOLS for AI.

EXACTIFICATION of TEXT follows a RUBRIC to determine HIGH_VALUE_AXIOMZ.

Specifically the AXIOM_COLLECTOR (either HITL or AI_as_JUDGE), generates AXIOMZ (visual concepts).

> AXIOMZ are CONCEPTS that are graded like DIAMONDS are graded with color, cut, carat, and clarity!

AXIOMZ are valuable because it enables Human or AI or BOTH - to conduct actual_extra_inference. or actual_extra_intellect.
...
It is easily realized, that a major fragility of traditional language, exists in simple naming!

Anyone can occasially notice a MISNOMER here and there, but also be entirely powerless with renaming consensus vocabulary.

Just as the concept of "recoining" is observably absent in our lexical reperatoir of tools. But not in ALPHABITZA!
...
#### "CONCEPTUAL_ACCESSIBILITY" is the reality that AI can easily be made inaccessable either by physical access or by AI communicating in binary!

That is why BITZ and AXIOMZ are solutions to the problem of CONCEPTUAL_ACCESSIBILITY. 
